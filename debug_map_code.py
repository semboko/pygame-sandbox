...
for x in range(20):
    ...
    self.scene.floor.bricks.append(
        TerrainBlock(xs - xs % TerrainBlock.width - TerrainBlock.width*1,y - y % TerrainBlock.height + TerrainBlock.width*x, self.scene.space,
                     self.scene.floor.sf, Swamp))

    self.scene.floor.bricks.append(
        TerrainBlock(xs - xs % TerrainBlock.width - TerrainBlock.width*2,y - y % TerrainBlock.height + TerrainBlock.width*x,self.scene.space,
                     self.scene.floor.sf, Mountain))
